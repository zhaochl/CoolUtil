...
//		return result;
	...
	public static void main(String[] args) {
		...
		url = "http://log.ymt360.com:9200/idx_ymt_shop_client_info/_search?pretty=true&q=status:1";
		
		hc.get(url);
		result = hc.getGetResult();
		System.out.println(result);
		System.out.println("===========2=================");
		url = "http://log.ymt360.com:9200/idx-new-order2/_search";
		jo = new JSONObject();
		jo.put("q", "status:1");
		jo.put("pretty", "true");
		...
		url = "http://log.ymt360.com:9200/im-2015-06-27/_search?pretty";
